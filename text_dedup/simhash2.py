...
import sys
sys.path.append("/mnt/vepfs/lingxin/pretrain/leileqi_test/dedup_code/text-dedup")
...
if __name__ == "__main__":
    ...
    args.local = False
    args.json = True
    args.path = '/mnt/vepfs/lingxin/pretrain/leileqi_test/xiaohongshu_dedup_test/xiaohongshu_save_emoji_end'
    # args.field = 'text'
    args.column = 'text'
    args.output = '/mnt/vepfs/lingxin/pretrain/leileqi_test/xiaohongshu_dedup_test/test_deduped'
    args.cache_dir = '/mnt/vepfs/lingxin/pretrain/leileqi_test/xiaohongshu_dedup_test/test_cache'
    args.num_proc = 30
    args.split = 'train'
    data_files = os.listdir(args.path)
    data_files = [os.path.join(args.path, data_file) for data_file in data_files][:25]
