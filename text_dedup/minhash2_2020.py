...
if __name__ == "__main__":  # pragma: no cover
    ...
    ##缓存目录
    args.cache_dir = '/mnt/lingxin/Pretrain-data/wulindong/weixin_cache4'
    ...
    for root,dir,filenames in os.walk(args.path):
        for filename in filenames:
            if filename.endswith('.json') and 'weixin_page.2020' in  filename:
    ...
    while start_index < data_files_len:
        ...
        save_name = f'weixin_page.2020_{start_index}.jsonl'
        args.split = 'train'
        args.num_perm = 30
        args.n_gram = 5
        # args.B = 10
