...
def add_io_args(parser: argparse.ArgumentParser) -> argparse.ArgumentParser:  # pragma: no cover
    ...
    """
    parser.add_argument("--path", type=str, help="`path` in load_dataset", default='/ok'),
    ...
    parser.add_argument("--output", type=str, help="Path to deduplicated dataset output", default='/ok'),
    parser.add_argument(
