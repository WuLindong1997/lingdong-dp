...
def get_args():
    ...
    parser.add_argument("--dataset-path", type=str, help="Dataset path we load the dataset from.",default='/mnt/vepfs/lingxin/pretrain/wulindong/code/dataprocessing-bigscience/preprocessing/training/01a_catalogue_cleaning_and_filtering/test.json')
    parser.add_argument("--preprocessings", nargs="*", type=str, 
                        choices=(MAPS_KEYS | FILTERS_KEYS | DEDUPS_KEYS),
                        help="List of dataset modification we apply in sequence.",default=['dedup_document'])
    parser.add_argument("--save-path", type=Path,default = '/mnt/vepfs/lingxin/pretrain/wulindong/code/dataprocessing-bigscience/preprocessing/training/01a_catalogue_cleaning_and_filtering/test_clean.json',
    ...
    parser.add_argument("--save-to-json", action="store_true", help="Save output dataset in json format.",default=True)
...
def main():
    ...
    if args.load_arrow_file:
        ...
        ds = load_dataset("json",data_files=args.dataset_path,split="train",cache_dir= '/mnt/vepfs/lingxin/pretrain/wulindong/cache1')
