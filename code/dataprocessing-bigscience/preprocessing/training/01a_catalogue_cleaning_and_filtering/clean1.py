...
def get_args():
    ...
    parser.add_argument("--dataset-path", type=str, help="Dataset path we load the dataset from.",default='/mnt/vepfs/lingxin/pretrain/wulindong/baike_1/baike_2000.json')
    parser.add_argument("--preprocessings", nargs="*", type=str, 
                        choices=(MAPS_KEYS | FILTERS_KEYS | DEDUPS_KEYS),
                        help="List of dataset modification we apply in sequence.",default='dedup_template_soft')
    parser.add_argument("--save-path", type=Path,default = '/mnt/vepfs/lingxin/pretrain/wulindong/baike_2/baike_2000.json',
