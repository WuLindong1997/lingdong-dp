...
toxic_path = "/mnt/vepfs/lingxin/pretrain/wulindong/code/dataprocessing-bigscience/preprocessing/training/01b_oscar_cleaning_and_filtering/filterwords/toxic.txt"
def get_args():
    parser = argparse.ArgumentParser()
    parser.add_argument("--file_path", type=str, default = '/mnt/vepfs/lingxin/pretrain/wulindong/baike_2098.json')
    parser.add_argument("--save_path", type=str,default = '/mnt/vepfs/lingxin/pretrain/wulindong/toxic_baike_2098.json')
...
def save_file(res):
    ...
    save_json(res,args.save_path,mode='a')
...
if __name__=='__main__':
    ...
    for data in load_json_yield(input_path=args.file_path):
        # print(data[0])
