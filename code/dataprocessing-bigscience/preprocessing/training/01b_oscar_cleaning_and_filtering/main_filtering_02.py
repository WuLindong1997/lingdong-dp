...
def parseArgs():
    ...
    parser.add_argument(
        ...
        type=str,
        default="/mnt/vepfs/lingxin/Pretrain-data/wulindong/code/dataprocessing-bigscience/zh.sp.model",
        help="Path to the Sentence Piece model used to tokenize text for perplexity scores.",
    )
    parser.add_argument(
        "--path_kenlm_model",
        type=str,
        default="/mnt/vepfs/lingxin/Pretrain-data/wulindong/code/dataprocessing-bigscience/zh.arpa.bin",
    ...
    parser.add_argument(
        ...
        type=str,
        default="/mnt/vepfs/lingxin/Pretrain-data/wulindong/bookdata/book_end",
        help="Path to the directory where the filtered version of the dataset will be saved.",
    )
    parser.add_argument(
        "--dataset_path",
        type=str,
        default="/mnt/vepfs/lingxin/Pretrain-data/wulindong/bookdata/book_format/part1/20世纪分析哲学史1：分析的开端.json",
        help="Path to the directory where the dataset was be saved.",
    )
    parser.add_argument(
        "--save_path",
        type=str,
        default="/mnt/vepfs/lingxin/Pretrain-data/wulindong/bookdata/book_end/1.json",
        help="Path to the directory where the dataset was be saved.",
    )
...
def main():
    ...
    dataset = load_dataset('json', data_files=args.dataset_path,cache_dir='/mnt/vepfs/lingxin/Pretrain-data/wulindong/bookdata/book_cache')
    ...
    dataset_filtering.filtering(args.save_path)
