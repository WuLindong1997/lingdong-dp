...
for file in /pretrain-data-bucket/pretrain_other/pretrain_else/xiaohongshu/note_2023*.7z; do
    # 使用basename命令获取文件名部分
    ...
    then
        ...
        7z x -o/mnt/vepfs/lingxin/pretrain/wulindong/xiaohongshu_un7z3/ $file
        filename=$(basename "$file")
        #转json格式
        python /mnt/vepfs/lingxin/pretrain/wulindong/code/xiaohongshu_code/trans_json_pool_2019.py \
            --data_path /mnt/vepfs/lingxin/pretrain/wulindong/xiaohongshu_un7z3/${filename%.*} \
            --save_path /mnt/vepfs/lingxin/pretrain/wulindong/xiaohongshu_json/${filename%.*}.json 
        wait
        echo "trans json ok!"
        rm -rf /mnt/vepfs/lingxin/pretrain/wulindong/xiaohongshu_un7z3/*
        wait
        #进行re正则清洗
        ...
        #文档间去重
        python /mnt/vepfs/lingxin/pretrain/wulindong/code/dataprocessing-bigscience/preprocessing/training/01a_catalogue_cleaning_and_filtering/clean3.py \
        ...
        rm -rf /mnt/vepfs/lingxin/pretrain/wulindong/cache3/*
        echo "rf cache ok!"
        #ppl
        python /mnt/vepfs/lingxin/pretrain/wulindong/code/dataprocessing-bigscience/preprocessing/training/01b_oscar_cleaning_and_filtering/main_filtering_04.py \
            ...
            --remove_meta \
            --num_proc 10 \
            --path_dir_save_dataset /mnt/vepfs/lingxin/pretrain/wulindong/xiaohongshu_8/  
        echo "ppl1 ok!"
        python /mnt/vepfs/lingxin/pretrain/wulindong/code/dataprocessing-bigscience/preprocessing/training/01b_oscar_cleaning_and_filtering/filter_with_perplexity.py\
            --dataset_path /mnt/vepfs/lingxin/pretrain/wulindong/xiaohongshu_8/zh \
            --save_path /mnt/vepfs/lingxin/pretrain/wulindong/xiaohongshu_5/${filename%.*}.json
        rm -rf /mnt/vepfs/lingxin/pretrain/wulindong/xiaohongshu_8/*
        ...
        rm -rf /mnt/vepfs/lingxin/pretrain/wulindong/cache_ppl3/*
        echo "ppl2 ok!"
        wait
    fi
done
