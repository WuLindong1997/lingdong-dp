...
for file in /pretrain-data-bucket/pretrain_other/pretrain_else/xiaohongshu/note_202304*.7z; do
    # 使用basename命令获取文件名部分
    ...
    then
        ...
        echo $file  ziping!
        7z x $file -o/pretrain-data-bucket/pretrain_other/pretrain_else/xiaohongshu_un7z -mmt20
        filename=$(basename "$file")
        #转json格式
        python /mnt/vepfs/lingxin/pretrain/wulindong/code/xiaohongshu_code/trans_json_pool_2023.py \
            --data_path /pretrain-data-bucket/pretrain_other/pretrain_else/xiaohongshu_un7z/${filename%.*} \
            --save_path /pretrain-data-bucket/pretrain_other/pretrain_else/xiaohongshu_save_emoji_json/${filename%.*}.json 
        wait
        echo "trans json ok!"
        rm -rf /pretrain-data-bucket/pretrain_other/pretrain_else/xiaohongshu_un7z/*
