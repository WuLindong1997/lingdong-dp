...
for file in /pretrain-data-bucket/pretrain_other/pretrain_else/xiaohongshu/xhs_notes.2019-*.7z; do
    ...
    then
        ...
        echo $file  ziping!
        7z x $file -o/pretrain-data-bucket/pretrain_other/pretrain_else/xiaohongshu_un7z2019 -mmt20
        filename=$(basename "$file")
        #转json格式
        python /mnt/vepfs/lingxin/pretrain/wulindong/code/xiaohongshu_code/trans_json_pool_2019-05-24.py \
            --data_path /pretrain-data-bucket/pretrain_other/pretrain_else/xiaohongshu_un7z2019/${filename%.*} \
            --save_path /pretrain-data-bucket/pretrain_other/pretrain_else/xiaohongshu_save_emoji_json/${filename%.*}.json 
        wait
        echo "trans json ok!"
        rm -rf /pretrain-data-bucket/pretrain_other/pretrain_else/xiaohongshu_un7z2019/*
