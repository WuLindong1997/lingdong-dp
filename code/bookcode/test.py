...
def get_args():
    ...
    # dictionary or file
    args_parser.add_argument('--dataset_path', type=str,default='/mnt/vepfs/lingxin/Pretrain-data/wulindong/code/bookcode/清洗-stage1/output_part1')
    args_parser.add_argument('--save_path', type=str,default='/mnt/vepfs/lingxin/Pretrain-data/wulindong/code/bookcode/bookdata_clean/book_json_part1')
