...
def get_args():
    ...
    # dictionary or file
    args_parser.add_argument('--dataset_path', type=str,default='/mnt/vepfs/lingxin/Pretrain-data/wulindong/sft_data/COIG-bleu')
    args_parser.add_argument('--save_path', type=str,default='/mnt/vepfs/lingxin/Pretrain-data/wulindong/sft_data/clean_data/COIG')
    args_parser.add_argument('--pool_num', type=int,default = 30)
    args_parser.add_argument('--num_parts', type=int,default = 10)
    # parse
