...
for file in /pretrain-data-bucket/pretrain_other/pretrain_else/weixin/page/weixin_page.2016-{11,12}*.7z; do
    # 使用basename命令获取文件名部分
    ...
    then
        ...
        7z x -o/pretrain-data-bucket/pretrain_other/pretrain_else/weixin_page_un7z2016 $file -mmt20
        echo '7z解压！！！！'
        mkdir /pretrain-data-bucket/pretrain_other/pretrain_else/weixin_page_clean/$filename_d
        
       
        python /mnt/lingxin/vepfs/pretrain/wulindong/weixin_page/code/clean_weixin/parse_html_pool_2016.py \
            --dataset_path   /pretrain-data-bucket/pretrain_other/pretrain_else/weixin_page_un7z2016/$filename_d \
            --save_path /pretrain-data-bucket/pretrain_other/pretrain_else/weixin_page_clean/$filename_d \
            --pool_num  14
        wait 
        rm -rf /pretrain-data-bucket/pretrain_other/pretrain_else/weixin_page_un7z2016/*
