...
for file in /pretrain-data-bucket/pretrain_other/pretrain_else/weixin/page/weixin_page.2017*.7z; do
    # 使用basename命令获取文件名部分
    ...
    then
        ...
        7z x -o/pretrain-data-bucket/pretrain_other/pretrain_else/weixin_page_un7z2017 $file -mmt20
        echo '7z解压！！！！'
        ...
        python /mnt/vepfs/lingxin/Pretrain-data/wulindong/weixin_page/code/clean_weixin/parse_html_pool_2018.py \
            --dataset_path   /pretrain-data-bucket/pretrain_other/pretrain_else/weixin_page_un7z2017/$filename_d \
            --save_path /pretrain-data-bucket/pretrain_other/pretrain_else/weixin_page_clean_special_token_other/$filename_d \
	        --batch_size 100000000\
            --pool_num  30
        wait
        rm -rf /pretrain-data-bucket/pretrain_other/pretrain_else/weixin_page_un7z2017/*
